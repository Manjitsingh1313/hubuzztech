            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-4">
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('properties/save') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <input type="number" name="area_sqft" class="form-control" placeholder="Area (sqft)"
                                    value="{{ old('area_sqft') }}">
                                @error('area_sqft')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="col">
                                <input type="number" name="parking" class="form-control" placeholder="Parking"
                                    value="{{ old('parking') }}">
                                @error('parking')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control " id="city_view"
                                        name="property_details[city_view]"
                                        value="{{ $property_details['city_view'] ?? '' }}">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="family_villa"
                                        name="property_details[family_villa]"
                                        value="{{ $property_details['family_villa'] ?? '' }}">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control " id="air_conditioned"
                                        name="property_details[air_conditioned]"
                                        value="{{ $property_details['air_conditioned'] ?? '' }}">
                                ...
                                <div class="col">
                                    ...
                                    <input type="tel" class="form-control" id="phone"
                                        name="property_details[phone]" pattern="[0-9]{10}"
                                        value="{{ $property_details['phone'] ?? '' }}">
                            ...
                            <div class="row mt-3">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="internet"
                                        name="property_details[internet]"
                                        value="{{ $property_details['internet'] ?? '' }}">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col">
                                <input type="tel" name="dealer_contact" class="form-control"
                                    placeholder="Dealer Contact" value="{{ old('dealer_contact') }}">
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                ...
                                <input type="file" class="inputfile form-control-file" id="photo" name="photo"
                                    accept="image/*">
                            ...
                            <div class="col">
                                ...
                                <input type="file" class="inputfile form-control-file" id="images" name="images[]"
                                    multiple accept="image/*">
                                <label for="images" class="file-upload-btn">Choose Photos</label>
                                @error('images')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
