{{-- <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  <a class="sidebar-brand d-flex flex-column align-items-center justify-content-center" href="{{ route('dashboard') }}">
      ...
      <div class="sidebar-brand-icon d-md-inline" style="font-variant-caps: unicase;">
          Hubuzz technology
      </div>
  </a>
...
<ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
  ...
  {{-- <li class="nav-item">
      <a class="nav-link collapsed" href="{{ route('dealers') }}" data-toggle="collapse" data-target="#collapseTwo"
      ...
      <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
              <h6 class="collapse-header">Dealers</h6>
              <a class="collapse-item" href="{{ route('dealers') }}">Dealers</a>
