...
<head>
    ...
    <title>Hubuzztechnology(Unify)- Register</title>
                        ...
                        @endif
                            <form action="{{ route('register.save') }}" method="POST" class="user">
                                ...
                                <div class="form-group">
                                  ...
                                  <select name="role" class="form-control form-control-user @error('role') is-invalid @enderror" id="exampleRole">
                                      <option value="" selected >Please select the role</option>
